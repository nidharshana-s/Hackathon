    ...
    <header className="border-b border-panelLine sticky top-0 z-20 backdrop-blur bg-[#12161Aee]">
      <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display font-bold text-xl tracking-tight text-ink">YARD/OPS</h1>
            <p className="text-xs text-inkDim font-mono -mt-0.5">FLEET RENTAL TRACKER · SITE NETWORK</p>
          </div>
        </div>
        <div className="text-right hidden sm:block">
          <p className="text-xs text-inkDim font-mono">DATA SYNC</p>
